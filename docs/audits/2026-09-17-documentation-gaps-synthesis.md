...
**Evidence:** `DefaultApiKeyStore.java:13-14` (AtomicReference), `ReentrantLock` (line 13), `Executors.newSingleThreadScheduledExecutor` (line 34) — implementation is thread-safe but the SPI contract does not state this.
