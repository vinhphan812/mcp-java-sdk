...
- `examples/src/main/java/io/github/vinhphan812/mcp/examples/ApiKeyStoreExample.java:8`: `constructor DefaultApiKeyStore in class DefaultApiKeyStore cannot be applied to given types; required: String,String,long; found: String`
- `examples/src/main/java/io/github/vinhphan812/mcp/examples/AuthorizationExample.java:8`: `incompatible types: incompatible parameter types in lambda expression`

## 3. Missing Examples

The following examples referenced in documentation or general project requirements are MISSING from `examples/src/main/java/io/github/vinhphan812/mcp/examples/`:
